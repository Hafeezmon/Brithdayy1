...
export default function App() {
  ...
  const photos = [
    "https://i.imgur.com/YKdmeY1.jpeg 
    ",
    "https://i.imgur.com/WHmx46C.jpeg
    ",
    "https://i.imgur.com/Q2EXM5H.jpeg",
    // Add more URLs of her photos here
  ];
  ...
  return (
    ...
    >
      ...
      <h1 style={{ fontSize: "3rem", color: "#d6336c", marginBottom: "20px" }}>
      ...
      >
        Nijumieee, this little website is made only for you 🌸
      </p>
